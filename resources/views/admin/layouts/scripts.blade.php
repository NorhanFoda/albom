 ...
 <script src="{{ asset('dashboard/app-assets/vendors/js/extensions/tether.min.js') }}"></script>
 <script src="{{ asset('dashboard/app-assets/vendors/js/extensions/shepherd.min.js') }}"></script>
 <!-- END: Page Vendor JS-->
